...
const vcard = 'BEGIN:VCARD\n' // Tarjeta de contacto
            ...
            + 'FN:Shanduy\n' // Nombre
            + 'ORG:Shanduy;\n' // Propietario
            + 'TEL;type=CELL;type=VOICE;waid=17472081051:+1 (747) 208-1051\n' // ID de WhatsApp + número de teléfono
            + 'END:VCARD'
/******END OF VCARD INPUT******/
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				levelnol: '*Nivel* 0 ',
				error: {
				stick: '[] Se produjo un error al convertir la imagen en Sticker, Intent�lo despu�s bldo.',
					Iv: '❌ LINK INVALIDO❌'
				},
				only: {
					group: '[] Este comando solo se puede usar en grupos pa',
					ownerG: '[] Este comando solo lo puede usar el due�o del grupo',
					ownerB: '[] Este comando solo lo puede usar el due�o del bot',
					admin: '[] Ten�s que ser admin para usar este comando bldo',
                    Badmin: '[] El bot tiene que ser admin para usar este comando',
                    daftarB: `*REGISTRATE CRACK�*\n\nHOLA !\n\nNo estas registrado en mi base de datos \n\nComando : ${prefix}daftar (Nombre)\nEjemplo :  ${prefix}daftar Benja 
`,
				}
			}
			...
			const ownerNumber = ["12603763944@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '17472081051@s.whatsapp.net'
                        /******ApiKey Input******/
